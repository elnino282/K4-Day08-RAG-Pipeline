...
def render_main_container():
    st.markdown(f'<header class="app-header"><div><p class="eyebrow">⚔️ GAMING META GUIDE</p><h2>{APP_TITLE}</h2></div><span>{APP_SUBTITLE}</span></header>', unsafe_allow_html=True)
    return st.container()
