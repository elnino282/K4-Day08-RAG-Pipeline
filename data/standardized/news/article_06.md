---
title: "TFT Set 17 champion cost role trait database"
game: "Teamfight Tactics"
customer_role: "player"
category: "champion-database"
patch_context: "Set 17 patch 17.8 snapshot compiled from OP.GG, TFTactics and MetaTFT pages"
source_url: "https://op.gg/tft/meta-trends/champion"
retrieved_at: "2026-08-04"
document_version: "not-stated"
source_file: "article_06.json"
---
# TFT Set 17 champion cost role trait database

This document lets the RAG assistant answer questions such as "Aatrox giá bao nhiêu vàng?", "Jhin mấy tiền?", "Bard thuộc hệ gì?", and "tướng này vai trò gì?". Cost data is patch-sensitive and should be cited with the source URL when answered.

| Champion | Giá vàng | Traits / Origin / Class | Role summary | Source |
|---|---:|---|---|---|
| Aatrox | 1 | N.O.V.A., Bastion | frontline bruiser / reroll tank-carry | TFTactics Aatrox page, OP.GG Aatrox page |
...
| Rhaast | 4 | bruiser / carry-flex comps | melee carry or frontline threat | TFTactics and OP.GG comp pages |
| Maokai | 1 | N.O.V.A.-related comps | early frontline tank | TFTactics and OP.GG comp pages |
| Jax | 1 | Stargazer / Challenger-related comps | reroll melee carry or item holder | TFTactics and OP.GG comp pages |
